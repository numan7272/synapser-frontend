      ...
      builder: (context, scrollController) {
        return Container(
          decoration: const BoxDecoration(
            color: SynapserTheme.bgSecondary,
            borderRadius: BorderRadius.vertical(top: Radius.circular(24)),
            border: Border(
              top: BorderSide(color: SynapserTheme.borderSubtle, width: 1),
              left: BorderSide(color: SynapserTheme.borderSubtle, width: 1),
              right: BorderSide(color: SynapserTheme.borderSubtle, width: 1),
            ),
          ),
